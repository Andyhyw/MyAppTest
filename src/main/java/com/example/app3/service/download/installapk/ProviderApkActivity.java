package com.example.app3.service.download.installapk;
...
import com.example.app3.util.PermissionUtil;
import com.example.app3.util.ToastUtil;
...
public class ProviderApkActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void installApk() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
            ...
            Log.d("hyw", String.format("new uri:%s", uri.toString()));
        }
