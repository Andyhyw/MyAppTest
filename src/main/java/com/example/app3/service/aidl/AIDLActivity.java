...
public class AIDLActivity extends AppCompatActivity {
        private IAidlService iAidlService;	//声明ITestService对象
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            intent.setAction("com.hsd.AIDL_SERVICE");		//为Intent设置Action
//		bindService(intent, conn, Service.BIND_AUTO_CREATE);	//Android 5.0以前绑定远程服务的代码
            ...
            btn.setOnClickListener(new View.OnClickListener() {//EVENTBUS

                @Override
                public void onClick(View v) {
                    try {
                        tv=(TextView)findViewById(R.id.test);	//获取显示内容的文本框组件
                        tv.setText("从远程服务获取的随机字符串："+ iAidlService.getTest()+iAidlService.getValue());	//从远程服务中获取生成的随机字符串显示到文本框中
